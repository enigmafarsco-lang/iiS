...
struct _fft_alg_data{
    ...
    fftw_complex *in_c;
    fftw_complex *out;
    QVector<double> *in_c_t;
    QVector<double> *out_t;
...
struct _transform {
    ...
    QVector<double> *seek_x_axis;
    QVector<double> *seek_y_axis;
    unsigned seek_x_axis_size;
    unsigned seek_y_axis_size;  
    bool destroy_x_axis;
    bool destroy_y_axis;
    bool destroy_seek_x_axis;
    bool destroy_seek_y_axis;
    QColor *graph_color;
    bool has_the_marker;
    void *settings;
...
struct _fft_settings {
    QVector<double> *real_source;
    QVector<double> *imag_source;
...
struct _constellation_settings {
    QVector<double> *x_source;
    QVector<double> *y_source;
    unsigned int num_samples;
};
...
public:
    ...
    void Transform_resize_seek_x_axis(Transform *tr, int new_size);
    void Transform_resize_seek_y_axis(Transform *tr, int new_size);
    QVector<double> *Transform_get_x_axis_ref(Transform *tr);
    QVector<double> *Transform_get_y_axis_ref(Transform *tr);
    ...
    QList<Transform*> *TrList_new(void);
    void TrList_destroy(QList<Transform*> *list);
    void TrList_add_transform(QList<Transform*> *list, Transform *tr);
    void TrList_remove_transform(QList<Transform*> *list, Transform *tr);
};
